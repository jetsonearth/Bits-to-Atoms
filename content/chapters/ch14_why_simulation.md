...
<figure>
  <img src="/images/ch14/isaac_sim_warehouse.png" alt="Isaac Sim 仓库仿真场景" />
  <figcaption>Isaac Sim 中的仓库仿真场景 — 货架、叉车、通道等元素高度还原真实仓库布局，用于验证导航和物流算法。图源：NVIDIA Developer Blog</figcaption>
</figure>
...
<figure>
  <img src="/images/ch14/isaac_sim_robot_arm.png" alt="Isaac Sim 中的机械臂仿真" />
  <figcaption>Isaac Sim 中的机械臂操作仿真 — 机器人在虚拟仓库中练习抓取和堆叠，所有碰撞和失败都不产生真实成本。图源：NVIDIA Developer Blog</figcaption>
</figure>
...
<figure>
  <img src="/images/ch14/gazebo_turtlebot3_world.png" alt="Gazebo 中的 TurtleBot3 仿真环境" />
  <figcaption>Gazebo 中的 TurtleBot3 仿真世界 — 开源、轻量，几秒钟启动，是 ROS 2 生态中最常用的仿真入口。图源：ROBOTIS TurtleBot3 Documentation</figcaption>
</figure>
