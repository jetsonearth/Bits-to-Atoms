...
<figure>
  <img src="/images/ch02/jetson_orin.jpg" alt="NVIDIA Jetson AGX Orin 开发者套件" />
  <figcaption>NVIDIA Jetson AGX Orin 开发者套件 — 目前机器人上最主流的边缘计算平台，为感知和决策提供 GPU 算力。图源：Wikimedia Commons</figcaption>
</figure>
...
<figure>
  <img src="/images/ch02/ros2_topics.gif" alt="ROS 2 Topic 通信模型：多个 Node 通过 Topic 实现 Pub/Sub 通信" />
  <figcaption>ROS 2 的 Topic 通信模型 — 多个 Node 通过 Topic 实现发布/订阅，就像微服务之间通过消息队列通信。图源：ROS 2 Documentation</figcaption>
</figure>
...
<figure>
  <img src="/images/ch02/nav2_slam.gif" alt="Nav2 + SLAM：机器人边导航边建图的实时可视化" />
  <figcaption>Nav2 + SLAM 实时可视化 — 左侧是 RViz 中逐步构建的 2D 占据栅格地图，右侧是仿真环境中的机器人视角。图源：Nav2 Documentation</figcaption>
</figure>
...
<figure>
  <img src="/images/ch02/isaac_lab.jpg" alt="NVIDIA Isaac Lab 中大规模并行训练人形机器人" />
  <figcaption>NVIDIA Isaac Lab — 在 GPU 上并行运行数千个机器人实例进行强化学习训练，这在真机上永远不可能实现。图源：NVIDIA</figcaption>
</figure>
