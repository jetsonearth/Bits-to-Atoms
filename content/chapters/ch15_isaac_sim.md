...
<figure>
  <img src="/images/ch15/isaac_sim_import_wizard.png" alt="Isaac Sim 导入向导界面" />
  <figcaption>Isaac Sim 的 Import Wizard 界面 — 引导你完成 URDF 到 USD 的转换，设置碰撞体、传感器和 ROS 2 桥接等关键参数。图源：NVIDIA Developer Blog</figcaption>
</figure>
...
<figure>
  <img src="/images/ch15/isaac_sim_ros_workflow.png" alt="Isaac Sim 到 ROS 2 的工作流程图" />
  <figcaption>Isaac Sim 与 ROS 2 的集成工作流 — 从 URDF 导入、传感器设置到 ROS 2 Bridge 连接，整个流程让仿真环境与真机软件栈无缝对接。图源：NVIDIA Developer Blog</figcaption>
</figure>
...
<figure>
  <img src="/images/ch15/isaac_lab_parallel_robots.png" alt="Isaac Lab 中多个人形机器人并行训练" />
  <figcaption>Isaac Lab 大规模并行训练 — 数千个人形机器人实例同时在 GPU 上运行，每个实例独立执行操作任务，训练速度比单实例快几个数量级。图源：NVIDIA Developer Blog</figcaption>
</figure>
...
<figure>
  <img src="/images/ch15/isaac_sim_people_warehouse.png" alt="Isaac Sim 仓库中的人员仿真" />
  <figcaption>Isaac Sim 仓库场景中的人员仿真 — 虚拟行人在货架间随机走动，帮助测试机器人在有人环境中的避障和导航能力。图源：NVIDIA Developer Blog</figcaption>
</figure>
