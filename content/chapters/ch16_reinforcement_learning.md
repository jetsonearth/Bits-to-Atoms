...
<figure>
  <img src="/images/ch16/rl_loop_diagram.png" alt="强化学习交互循环示意图" />
  <figcaption>强化学习的核心循环 — Agent 观察环境状态（State），执行动作（Action），环境返回奖励（Reward）和新状态，如此往复直到学会最优策略。图源：Wikimedia Commons (CC0)</figcaption>
</figure>
...
<figure>
  <img src="/images/ch16/isaac_lab_factory_training.png" alt="Isaac Sim 高保真仿真工厂场景" />
  <figcaption>Isaac Sim 中的高保真仿真工厂 — 自动叉车在虚拟仓库中运行，光线追踪渲染让仿真环境的视觉效果逼近真实照片，为感知模型训练提供高质量合成数据。图源：NVIDIA Developer Blog</figcaption>
</figure>
...
<figure>
  <img src="/images/ch16/bimanual_manipulation.jpg" alt="人形机器人在仿真中练习物体操作" />
  <figcaption>人形机器人在 Isaac Lab 中练习抓取和放置任务 — 操作类任务（manipulation）是 RL 的另一个重要应用场景，通常使用 SAC 等数据效率更高的算法。图源：NVIDIA Developer Blog</figcaption>
</figure>
